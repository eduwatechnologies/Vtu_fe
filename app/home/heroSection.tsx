        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Recharge airtime, buy data bundles, pay electricity bills, and
              subscribe to cable TV instantly. Fast, secure, and reliable VTU
          ...
          <div className="relative flex justify-center lg:justify-end">
            <Image
              src={HeroImage}
              alt="Hero"
              className="w-[300px] md:w-[400px] lg:w-[1000px] h-auto"
              priority
            />
          </div>
        </div>
