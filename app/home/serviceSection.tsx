...
export function ServiceSection() {
    ...
    const services = [
    {
      ...
      description: "Instant airtime for all networks with competitive rates and instant delivery",
    ...
    },
    {
      icon: Wifi,
      title: "Data Bundles",
      description: "Affordable data plans for MTN, Airtel, Glo, and 9mobile networks",
      features: ["All Data Plans", "SME & Gifting", "Auto Renewal", "Bulk Purchase"],
      price: "From ₦100",
    },
    {
      icon: Zap,
      title: "Utility Bills",
      description: "Pay electricity, cable TV, internet, and other utility bills seamlessly",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 fade-in-element">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive VTU solutions designed to meet all your digital transaction needs
            </p>
          </div>
