    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 px-6 py-12 md:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="space-y-4">
          <p>
            Welcome to <strong>PayOnce</strong>. By using our VTU services, you
          ...
          <p>
            You may not use PayOnce for any illegal or fraudulent activity or to
            interfere with our platform or services.
          </p>
          ...
          <p>
            We may suspend or terminate accounts involved in fraud or violation
            of these terms.
          </p>
